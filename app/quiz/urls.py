...
from quiz.views import StudentClassView, TeacherCabinetView, QuizzesListView, QuizDetailView, IndexView, TeacherQuizzesView, CreateQuizView, AddQuestionsView
